...
# the pencil that opens the correction form. The demo seed fills "Recent shifts" on
# Docents with ended Shifts and their filed counts, so the pencil has a seat to show.
...
act openRecentSchedule              # open Recent shifts, whose seats carry filed counts
