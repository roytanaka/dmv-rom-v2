...
| B   | Audience menu, stepped sheet (**winner**, 2026-09-06) | A menu naming the Audiences at the entry point                                                   | Step 1 is the chosen Audience expanded into a To field of name chips (× removes; "Add people" opens a search-and-tick panel); count in the step header | Step 2 in a side sheet; step 3 is the result |
