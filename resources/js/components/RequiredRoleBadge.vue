...
// article's task needs — "Scheduler or Chair" — beside its title in the index
...
// Labels and the "or" joiner are chrome (ADR-0004), resolved via trans()
// wrapped in computed so they survive the async message load and a full-page locale switch.
...
const label = computed(() => {
    ...
    return roles.join(` ${trans('help.required_role.or')} `);
});
</script>
