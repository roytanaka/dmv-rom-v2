...
> **Amendment (2026-09-08, [#480](https://github.com/roytanaka/dmv-rom-v2/issues/480)).** The picker rule for the org-wide Audiences follows legacy's **DMV-list rule**, wider than the Records-only column below. An **org-wide sender** is a member of the Executive, Records, or Awards Group — the three that steward a new `org_mail` function — or a **Chair of any active Group at any depth**; super-tier inherits it. So **All Members**, **All Members and on leave**, **Active and Provisional**, and **One Category** need an org-wide sender, not Records; and **Board of Directors**, **Committee Chairs**, and **All Chairs** are open to **any Member**. This supersedes the "Records" reading in the table, the "Three deviations" paragraph's "every org-wide Audience now needs Records", and the Consequences bullet "Org-wide mail moves from Chairs to Records". Realized in `Member::isOrgWideSender()`; reversal is still one rule — narrow that predicate.
...
- **Org-wide mail moves from Chairs to Records.** A committee Chair who mailed All Members in legacy now asks Records or uses their Group's Audiences. Reversible in one rule. _(Amended 2026-09-08, [#480](https://github.com/roytanaka/dmv-rom-v2/issues/480): widened to legacy's DMV-list rule — the Executive, Records, and Awards Groups, and any active-Group Chair at any depth, may send org-wide, so a Chair keeps the franchise. See the §5 amendment.)_
