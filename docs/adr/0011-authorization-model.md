...
- **Cross-cutting permissions are explicit, not derived from Group membership.** "Can edit news" is the worked example: a named permission grantable to a role or person, rather than implied by membership of a particular communications group.
